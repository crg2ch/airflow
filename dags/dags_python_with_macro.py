...
with DAG(
    ...
    @task(task_id='task_using_macros',
          templates_dict={
              ...
              'end_date':'{{ ( data_interval_end.in_timezone("Asia/Seoul") + macros.dateutil.relativedelta.relativedelta(day=1) + macros.dateutil.relativedelta.relativedelta(day=-1) ) | ds }}'
              }
    )
    def get_datetime_macro(**kwargs):
        templates_dict = kwargs.get('templates_dict') or {}
        start_date = templates_dict.get('start_date') or None
        end_date = templates_dict.get('end_date') or None
